import Node from "./NodeForHashSet.js"
...
export default class LinkedList{
    ...
    // this method adds a new node containing key to the end of the list
    append(key){
    ...
    // this method adds a new node containing key to the start of the list
    prepend(key){
        let newNode = new Node(key);
    ...
    // this method inserts a new node with the provided key at the given index.
    insertAt(key, index){
        if (index<0 || index > this.#size)
            return null;
        ...
        let newNode = new Node(key, nodeAtIndex.next);
